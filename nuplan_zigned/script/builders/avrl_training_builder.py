...
from nuplan_zigned.script.builders.avrl_objectives_builder import build_objectives
...
from nuplan_zigned.training.modeling.avrl_lightning_module_wrapper import LightningModuleWrapper
from nuplan.planning.training.modeling.torch_module_wrapper import TorchModuleWrapper
from nuplan.planning.utils.multithreading.worker_pool import WorkerPool

from nuplan_zigned.training.preprocessing.avrl_feature_preprocessor import FeaturePreprocessor
from nuplan_zigned.script.builders.avrl_training_callback_builder import build_callbacks
...
def build_lightning_module(cfg: DictConfig, torch_module_wrapper: TorchModuleWrapper) -> pl.LightningModule:
    ...
    """
    # Build loss
    objectives = build_objectives(cfg, torch_module_wrapper)
