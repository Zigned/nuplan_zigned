...
from nuplan_zigned.nuboard.nuboard import NuBoard
...
def initialize_nuboard(cfg: DictConfig) -> NuBoard:
    ...
    nuboard = NuBoard(
        ...
        ego_trajectory_plotted=cfg.ego_trajectory_plotted,
        max_num_step_trajectory=cfg.max_num_step_trajectory,
        num_modes_plotted=cfg.num_modes_plotted,
    )
