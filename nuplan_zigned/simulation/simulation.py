...
from nuplan_zigned.simulation.history.simulation_history import SimulationHistory, SimulationHistorySample
...
class Simulation:
    ...
    def propagate(self, trajectory: AbstractTrajectory, rest_modes: Optional[List[AbstractTrajectory]]) -> None:
        """
        ...
        self._history.add_sample(
            SimulationHistorySample(iteration, ego_state, trajectory, rest_modes, observation, traffic_light_status)
        )
