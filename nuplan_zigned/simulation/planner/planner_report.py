...
@dataclass(frozen=True)
class MLPlannerReport(PlannerReport):
    """MLPlanner-specific runtime stats."""
    ...
    data_driven_runtimes: List[float]
    model_driven_runtimes: List[float]
    hybrid_driven_runtimes: List[float]
