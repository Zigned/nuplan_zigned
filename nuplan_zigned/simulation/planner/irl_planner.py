...
from nuplan_zigned.simulation.planner.avrl_model_loader import ModelLoader
from nuplan_zigned.simulation.planner.avrl_transform_utils import transform_predictions_to_states


class IRLPlanner(AbstractPlanner):
    """
    ...
    def compute_planner_trajectory(self, current_input: PlannerInput) -> AbstractTrajectory:
        ...
        features = self._model_loader.build_features(current_input, self._initialization, self._scenario)
