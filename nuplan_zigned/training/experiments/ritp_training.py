...
from nuplan_zigned.script.builders.utils.utils_config import scale_cfg_for_distributed_training
from nuplan_zigned.script.builders.ritp_training_builder import (
...
def build_training_engine(cfg: DictConfig, worker: WorkerPool) -> TrainingEngine:
    ...
    model.env = trainer.train_loop.env
    model.model.env = trainer.train_loop.env
    model.model.replay_buffer = trainer.train_loop.replay_buffer
