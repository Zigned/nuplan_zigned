...
class GenericAgents(AbstractModelFeature):
    ...
    def batch_size(self) -> int:
        ...
        """
        return len(self.agent_data['position']) if self.agent_data is not None else None
    ...
    def unpack(self) -> List[GenericAgents]:
        ...
        return [
            GenericAgents(
                agent_data={key: [value[sample_idx]] for key, value in self.agent_data.items()},
            )
