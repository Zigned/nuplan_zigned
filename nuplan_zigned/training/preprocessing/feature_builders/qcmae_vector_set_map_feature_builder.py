...
from nuplan_zigned.training.preprocessing.feature_builders.qcmae_feature_builder_utils import (
...
class VectorSetMapFeatureBuilder(ScriptableFeatureBuilder):
    ...
    def __init__(
        ...
        :param dim (int, Optional): 2D or 3D data. (default: 3)
    ...
    def get_map_data(self, list_tensor_data: Dict[str, List[Union[Dict[str, torch.Tensor], List[Any]]]]) -> Dict[Union[str, Tuple[str, str, str]], Any]:
        ...
        for sample_idx in range(batch_size):
            ...
            for i_element in range(num_lanes):
                ...
                polygon_tl_statuses[idx_offset_pl + i_element] = self._traffic_light_one_hot_decoding[tuple(tl_status)]
