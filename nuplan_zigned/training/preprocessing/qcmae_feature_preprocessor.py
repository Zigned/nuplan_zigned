...
from nuplan_zigned.training.preprocessing.utils.qcmae_utils_cache import compute_or_load_feature
...
class FeaturePreprocessor:
    ...
    def _compute_all_features(
        ...
        data_across_builders = None

        for builder in builders:
            feature, feature_metadata_entry, data_across_builders = compute_or_load_feature(
                scenario, self._cache_path, builder, self._storing_mechanism, self._force_feature_computation, data_across_builders
            )
