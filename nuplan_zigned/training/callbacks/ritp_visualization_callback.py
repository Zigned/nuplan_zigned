...
class VisualizationCallback(pl.Callback):
    ...
    def _log_from_dataloader(
        ...
        for batch_idx, batch in enumerate(dataloader):
            ...
            iteration = 0
            batch_size = len(features['vector_set_map'].map_data['map_polygon']['position'])
            ...
            for sample_idx in range(batch_size):
                ...
                for id, traj in trajectories_tg[sample_idx].items():
                    trajectory = traj[iteration: iteration + num_future_steps]
                    traj_tg[id] = traj.new_tensor(trajectory)
            ...
            # TODO doesn't work. to be continued...
