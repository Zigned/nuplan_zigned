...
from nuplan_zigned.nuboard.base.simulation_tile import SimulationTile
...
class ScenarioTab(BaseTab):
    ...
    def __init__(
        ...
        self.simulation_tile = SimulationTile(
            ...
            ego_trajectory_plotted=ego_trajectory_plotted,
            max_num_step_trajectory=max_num_step_trajectory,
            num_modes_plotted=num_modes_plotted,
        )
