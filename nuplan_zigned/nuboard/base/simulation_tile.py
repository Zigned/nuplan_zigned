...
from nuplan.planning.nuboard.base.plot_data import MapPoint, SimulationData
...
from nuplan_zigned.nuboard.base.plot_data import SimulationFigure
...
class SimulationTile:
    ...
    def __init__(
        ...
        ego_trajectory_plotted: str = 'simulated_trajectory',
        max_num_step_trajectory: Optional[int] = None,
        num_modes_plotted: int = 1,
    ):
        """
        ...
        :param ego_trajectory_plotted: plot simulated or predicted ego trajectory.
        :param max_num_step_trajectory: maximum number of steps of the plotted trajectory.
        :param num_modes_plotted: number of predicted modes to be plotted.
        """
        self._doc = doc
        ...
        self._ego_trajectory_plotted = ego_trajectory_plotted
        self._max_num_step_trajectory = max_num_step_trajectory
        self._num_modes_plotted = num_modes_plotted
    ...
    def init_simulations(self, figure_sizes: List[int]) -> None:
        ...
        for figure_index in range(len(self._selected_scenario_keys)):
            ...
            # TODO set output_backend="svg" for saving vectorgraph
            simulation_figure = self._create_initial_figure(figure_index=figure_index, figure_sizes=figure_sizes, backend="svg")
    ...
    def _render_expert_trajectory(self, main_figure: SimulationFigure) -> None:
        """
        ...
        if self._max_num_step_trajectory is not None:
            # TODO cut expert ego trajectory to self._max_num_step_trajectory frames
            source.data['xs'] = source.data['xs'][:self._max_num_step_trajectory]
            source.data['ys'] = source.data['ys'][:self._max_num_step_trajectory]
    ...
    def _render_plots(
        ...
        main_figure.ego_state_trajectory_plot.update_plot(
            ...
            frame_index=frame_index,
            doc=self._doc,
            ego_trajectory_plotted=self._ego_trajectory_plotted,
            num_modes_plotted=self._num_modes_plotted,
        )
